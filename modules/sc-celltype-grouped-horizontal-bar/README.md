...
**Faceted horizontal bars of cell-type proportions**

Compare group-level cell-type proportions in side-by-side horizontal facets.
...
需要 R 4.5 或兼容版本，以及：`dplyr`, `ggplot2`。
