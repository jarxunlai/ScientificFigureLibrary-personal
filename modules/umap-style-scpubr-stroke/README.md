...
**Black-stroke granule UMAP**

A marker UMAP with black outlines, cluster labels, and a compact bottom legend.

## 用途

Emphasize point boundaries and preserve cluster identity in a dense embedding.
...
需要 R 4.5 或兼容版本，以及：ggplot2, dplyr, shadowtext。
