...
**Square-axis labelled UMAP**

A square-axis UMAP with direct cluster labels and a fixed symmetric coordinate range.

## 用途

Present a compact, equal-aspect embedding with stable axis limits.
