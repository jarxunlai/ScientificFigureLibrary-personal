...
**In-situ labelled UMAP**

A directly labelled UMAP with corner arrows standing in for a specialized cluster-axis theme.

## 用途

Place cell-type names in the embedding while retaining a small coordinate cue.
