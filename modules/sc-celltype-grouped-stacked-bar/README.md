...
**Grouped 100% stacked bars of cell composition**

Compare group-level cell composition with normalized stacked bars.
...
需要 R 4.5 或兼容版本，以及：`dplyr`, `ggplot2`, `RColorBrewer`。
