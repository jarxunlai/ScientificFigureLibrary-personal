...
**UMAP with translucent ellipses and matching labels**

A UMAP module with translucent per-cluster ellipses and labels in matching colors.

## 用途

Show cluster shape and location while removing a separate legend.
...
需要 R 4.5 或兼容版本，以及：ggplot2, dplyr, ggrepel, colorspace。
